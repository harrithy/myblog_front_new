...
.markdown-body {
  ...
  font-size: 17px; // 稍微大一点的字体，提高阅读体验
  line-height: 1.85;
  ...
  pre {
    ...
    font-size: 0.95em;
    line-height: 1.6;
    background-color: #2d2a2e; // 深色背景对比度更好
    border-radius: 8px;
  ...
  hr {
    ...
    &::after {
      ...
      background-color: #fffcf9; // 需要匹配背景色
      padding: 0 10px;
      color: $color-accent;
      font-size: 20px;
    }
