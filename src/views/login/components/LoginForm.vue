...
import type { LoginFormCopy } from '../loginCopy'
...
const model = defineModel<LoginFormState>({ required: true })
...
<template>
  <form class="auth-form" @submit.prevent="emit('submit')">
    ...
    <div class="auth-form__options">
      ...
      <span class="auth-form__caption">{{ copy.helperCaption }}</span>
    </div>
...
.auth-form__input {
  ...
  border-radius: 22px;
  background: linear-gradient(180deg, rgba(255, 255, 255, 0.78), rgba(255, 249, 252, 0.68));
...
.auth-form__github {
  ...
  padding: 14px 18px;
  border-radius: 999px;
  background: linear-gradient(180deg, rgba(255, 255, 255, 0.84), rgba(255, 249, 252, 0.76));
